...
J2534Error[ERR_INVALID_CHANNEL_ID] = ('ERR_INVALID_CHANNEL_ID',
                                      'Invalid ChannelID value')
...
J2534Error[ERR_INVALID_PROTOCOL_ID] = ('ERR_INVALID_PROTOCOL_ID', 'Invalid ProtocolID value, unsupported ProtocolID, or there is a resource conflict (i.e. trying to connect to multiple protocols that are mutually exclusive such as J1850PWM and J1850VPW, or CAN and SCI A, etc.)')
...
J2534Error[ERR_INVALID_IOCTL_VALUE] = ('ERR_INVALID_IOCTL_VALUE',
                                       'Invalid value for Ioctl parameter')
# Invalid flag values
ERR_INVALID_FLAGS   = 0x06
J2534Error[ERR_INVALID_FLAGS] = ('ERR_INVALID_FLAGS', 'Invalid flag values')
...
J2534Error[ERR_DEVICE_NOT_CONNECTED] = ('ERR_DEVICE_NOT_CONNECTED',
                                        'Device ID invalid')
...
ERR_TIMEOUT     = 0x09
J2534Error[ERR_TIMEOUT] = ('ERR_TIMEOUT', 'Timeout')

# Invalid message structure pointed to by pMsg (Reference Section 8 � Message Structure)
ERR_INVALID_MSG    = 0x0A
J2534Error[ERR_INVALID_MSG] = ('ERR_INVALID_MSG',
                               'Invalid message structure pointed to by pMsg')

# Invalid TimeInterval value
ERR_INVALID_TIME_INTERVAL = 0x0B
J2534Error[ERR_INVALID_TIME_INTERVAL] = ('ERR_INVALID_TIME_INTERVAL',
                                         'Invalid TimeInterval value')

# Exceeded maximum number of message IDs or allocated space
ERR_EXCEEDED_LIMIT   = 0x0C
J2534Error[ERR_EXCEEDED_LIMIT] = (
    'ERR_EXCEEDED_LIMIT',
    'Exceeded maximum number of message IDs or allocated space')

# Invalid MsgID value
ERR_INVALID_MSG_ID   = 0x0D
J2534Error[ERR_INVALID_MSG_ID] = ('ERR_INVALID_MSG_ID', 'Invalid MsgID value')

# Device is currently open
ERR_DEVICE_IN_USE   = 0x0E
J2534Error[ERR_DEVICE_IN_USE] = ('ERR_DEVICE_IN_USE',
                                 'Device is currently open')

# Invalid IoctlID value
ERR_INVALID_IOCTL_ID  = 0x0F
J2534Error[ERR_INVALID_IOCTL_ID] = ('ERR_INVALID_IOCTL_ID',
                                    'Invalid IoctlID value')
...
J2534Error[ERR_INVALID_FILTER_ID] = ('ERR_INVALID_FILTER_ID',
                                     'Invalid Filter ID value')

# No flow control filter set or matched (for protocolID ISO15765 only)
ERR_NO_FLOW_CONTROL   = 0x17
J2534Error[ERR_NO_FLOW_CONTROL] = ('ERR_NO_FLOW_CONTROL',
...
J2534Error[ERR_INVALID_DEVICE_ID] = ('ERR_INVALID_DEVICE_ID',
                                     'Unable to communicate with device')
